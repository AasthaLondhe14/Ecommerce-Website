...
const Product = mongoose.model("Product", {
    _id: {
        ...
        auto: true, // Primary key (automatically generated)
    },
    id: {
        type: Number,
        required: true,
...
const User = mongoose.model("User", {
    ...
    cartData: {
        type: Map,
        of: Number, // Tracks product IDs and their quantities
        default: {},
    },
    date: {
        type: Date,
...
// API to Get Popular Items in Women Section
